...
function fence(s) {
  ...
  return String(s).replace(/<\/?(user|clawd|draft|reply|image|conversation)>/gi, m => m.replace("<", "‹"));
}

export function buildPrompt(messages, currentDraft, turnsLeft) {
